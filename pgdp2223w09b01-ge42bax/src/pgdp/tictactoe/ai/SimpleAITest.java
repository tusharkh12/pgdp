...
public class SimpleAITest {
    ...
    class AIcouldWin{
        ...
        void basicExampleTwo(){
            Field[][] board = {
                    {new Field(6, false), null, new Field(5, false)},
                    {null,new Field(7, true), null,null},
                    {null, null, new Field(8, true)}
            };
            SimpleAI ai = new SimpleAI();
            Game.printBoard(board);
            boolean[] firstPlayedPieces = {false, false, true, false, false, false, false, true, true};
            boolean[] secondPlayedPieces = {false, false, false, false, false, false, true, false, false};
            Move move = ai.makeMove(board, true, firstPlayedPieces, secondPlayedPieces);
            Game.printBoard(board);
    ...
    class OpponentCouldWin{
        ...
        void basicExampleTwo(){
            Field[][] board = {
                    {new Field(6, true), null,null},
                    {null, new Field(5, false), null},
